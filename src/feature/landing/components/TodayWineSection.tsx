...
const TodayWineSection = () => {
  ...
  return (
    <section
      ref={section2Ref}
      className='relative z-[10] mx-auto mb-[30dvh] flex h-[50.8rem] max-w-[34.3rem] justify-center pt-[13rem] md:mt-[10dvh] md:max-w-[42.5rem] md:pt-[15.8rem] xl:mt-0 xl:mb-0 xl:flex xl:h-[100dvh] xl:max-w-none xl:items-center xl:justify-between xl:pt-0'
    >
      <div className='w-[16.5rem] overflow-hidden md:w-[20.3rem] xl:w-[25.5rem]'>
        <motion.h2
        ...
        >
          매달 새롭게 추천되는 <br />
          다양한 인기 와인을 <br className='xl:hidden' />
          만나보세요.
        </motion.p>
      </div>

      <div className='xl:relative xl:h-[52rem] xl:w-[50rem]'>
        <motion.div
        ...
        >
          <Image
            ...
            height={367}
            draggable='false'
            className='select-none md:h-auto md:w-[26.9rem] xl:w-[25rem]'
          />
        </motion.div>
        ...
        >
          <Image
            ...
            height={364}
            draggable='false'
            className='select-none md:h-auto md:w-[60rem] xl:w-[46rem]'
          />
        </motion.div>
      </div>
    </section>

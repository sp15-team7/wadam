...
const WineReviewSection = () => {
  ...
  return (
    <section
      ref={section4Ref}
      className='relative z-[10] mt-[15rem] md:mt-[20dvh] lg:mt-[30dvh] xl:mt-0 xl:flex xl:h-[calc(100dvh-15rem)] xl:flex-col xl:justify-between'
    >
      <div className='xl:flex xl:flex-row-reverse xl:items-center xl:justify-between'>
        <motion.div
          ...
          className='absolute top-0 left-0 z-[-1] md:top-[30%] md:left-[50%] md:translate-x-[-50%] md:translate-y-[-50%] xl:static xl:z-0 xl:w-[50rem] xl:translate-x-[10%] xl:translate-y-[15%]'
        ...
        <div className='pt-[21rem] text-center xl:text-left'>
          ...
          >
            와인은 취향의 언어죠. <br />
            다른 사람들의 솔직한 한 잔의 이야기에서 <br />내 취향을
            발견해보세요.
          </motion.p>
        </div>
      </div>
      ...
      >
        <Button
          size='full'
          onClick={handleClick}
          className='mx-auto mt-[20rem] text-[1.4rem] md:mt-[40rem] md:max-w-[57.6rem] md:text-[1.8rem] xl:mt-0 xl:max-w-[76.8rem]'
        >
          시작하기
        </Button>
      </motion.div>
